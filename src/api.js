...
//PUT API multiple data in array
// app.put("/nodeapi/test/multidata", function (req, res) {
// 	sql.connect(sqlConfig, function () {
// 		for (var x = 0; x < req.body.arr[0].test.length; x++) {
// 			var request = new sql.Request();
// 			id = parseInt(req.body.arr[0].test[x].id);
// 			desc = req.body.arr[0].test[x].desc;

// 			request.query("UPDATE " + sqlSchema + ".jengtable SET desc= '" + desc + "'  WHERE id= " + id, function (err) {
// 				if (err) {
// 					res.end(err);
// 					console.log(err);
// 				}
// 				else {
// 					res.end("Successfully update multidata");
// 				}
// 			});
// 		}
// 	});
